...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("000000 ?????? ????? 101 ????? 00100 11", srli   , I, R(dest) = src1 >> BITS(src2, 5, 0)); //或者BITS(src1,63,src2)
  ...
  // INSTPAT("000000 ?????? ????? 101 ????? 01100 11", srl    , R, R(dest) = src1 >> BITS(src2, 5, 0));
  // INSTPAT("010000 ?????? ????? 101 ????? 01100 11", sra    , R, R(dest) = (sword_t)src1 >> BITS(src2, 5, 0));
